...
export default function Dashboard() {
  ...
  return (
    ...
    <a href="/ConsultationForm" id="newconbtn"><img id="ellipsebtn" src={ellipse}/> New Consultation</a>
    <a href="/Choice" id="newconbtn"><img id="ellipsebtn" src={ellipse}/> New Consultation</a>
    </>
