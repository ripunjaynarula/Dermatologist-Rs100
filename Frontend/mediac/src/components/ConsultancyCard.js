...
export default function ConsultancyCard() {
      ...
      if (currentUser) {
        ...
        if (res["status"]) {
          ...
          if (res.consultation.length > 1) {
            setTitle(
              "You have " +
                res.consultation.length.toString() +
  ...
  return (
    <>
      {active ? (
        <div className="row" id="cardcontainer" style={{ display: "flex" }}>
          <p href="#" className="endbtn">
            End Consultation
          </p>
          <p>{title}</p>
          <p href="#" className="bookbtn" onClick={handleShow}>
            View
          </p>
              ...
              <div className="card" id="popup">
                <div className="container" id="cardcontainer">
                  ...
                  <div style={{ position: "relative" }}>
                    <div id="cardprimary">
                      <p>
                        <b>Doctor's Email:</b> {docMail}
                      </p>
                      <p style={{ align: "right", display: "relative" }}>
                        <b>Start Date:</b> {startDate.toString().slice(0, 10)}
                      </p>
                      <p>
