        ...
        <DataContext.Provider value={[consultationData, setConsultationData]}>
          ...
          <div  >
            <Switch>
              ...
              <Route   path="/pimples-acne-treatment" component={pimplesAcnePage} />
              <Route   path="/psoriasis-treatment" component={pimplesAcnePage} />
              <Route   path="/eczema-treatment" component={pimplesAcnePage} />
              <Route   path="/warts-molluscumcontagiosum-treatment" component={pimplesAcnePage} />
              <Route   path="/vitiligo-treatment" component={pimplesAcnePage} />
              <Route   path="/hyper-pigmentation-malesma-teratment" component={pimplesAcnePage} />
              <Route   path="/moles-or-nevi-skin-tags-treatment" component={pimplesAcnePage} />
              <Route   path="/fungal-infections-treatment" component={pimplesAcnePage} />
              <Route   path="/keloid-hypertrophic-scar" component={pimplesAcnePage} />
              <Route   path="/hair-loss-treatment" component={pimplesAcnePage} />
              <Route   path="/lichen-planus-treatment" component={pimplesAcnePage} />
              ...
              <Route  path="/lavatron-diathermy-therapy-treatment" component={treatment} />
              <Route  path="/chemical-skin-peel-treatment-consultation" component={treatment} />
              <Route  path="/dermaroller-and-mesotherapy-treatmen-consultaion" component={treatment} />
              <Route  path="/botox-and-fillers-treatment-consultaion" component={treatment} />
              <Route  path="/vitiligo-treatments-consulation" component={treatment} />
              <Route  path="/hair-transplant-treatment-consultation" component={treatment} />
              <Route  path="/viora-reaction-treatment-consultation" component={treatment} />
              <Route  path="/cosmetic-surgery-treatment-consultaion" component={treatment} />
              <Route  path="/melasma-pigmentation-treatment" component={treatment} />
              <Route  path="/hair-treatment-consultation" component={treatment} />
              <Route  path="/tattoo-removal-consultation" component={treatment} />
              <Route  path="/glutathione-fairness-injections" component={treatment} />
