...
<li>Warts</li>
     ...
     `,
            ` <h3>How are fractional CO2 laser treatments performed?</h3>
      <p>The area to be treated is cleansed first and then a numbing cream is applied. After you numb for about an hour, parameters are set in the machines according to the skin type and nature of the lesion and laser beam is given in a uniform pattern. The treatment takes about 5 minutes for a full face and feels like "pins and needles" sensation which is tolerable. Ice or cooling gel pack is applied on the area before, during and after the treatment, to make it comfortable.</p>
      <h3>What benefits can I expect?</h3>
      <p>Results are very encouraging. There would be a noticeable reduction in scars and open pores from the first sitting itself. Other components of sun damaged skin will also be benefited such as age-spots, fine lines, wrinkles, uneven coloration, skin laxity, textural irregularities. The skin will continue to improve for a period of 6 months following the procedure, provided proper skincare is used and sun exposure is minimized.</p>
      <h3>When will I see results?</h3>
      <p>Bear in mind that the fractional CO2 laser can be customized. Treatments can be deeper, with more healing and downtime, or shallower, with less healing time. Generally, the deeper the treatment, the better the results.</p>
      <p>You will see some immediate results. Lightening of the scars would be noticed after first session only but full results may take 3-6 months. After your skin heals, which may take up to 3-14 days, there will be a period of 4 to 6 weeks, when your skin might be slightly pink. During this period, your skin will feel smoother and looks less blotchy. As the colour returns to normal, you will see fewer lines, less blotchiness, and more glow. </p>
      <h3>How many treatments will I need?</h3>
      <p>The number depends on the extent of sun damage, depth of the scars or wrinkles and conditions to be treated. Generally, 8-10 sessions are recommended to get the desired results.</p>
      <h3>What are the risks and side effects?</h3>
      <p>Depending on the area and the aggressiveness of the treatment, it will take 5-7days for the skin to heal. This downtime will include mild redness, dryness, flaking or pigmentation. It is important to follow the instructions given by your dermatologist along with sun protection to prevent complications. Since, we at the skin n laser centre use the best quality laser i.e. <strong>Acupulse fractional co2 laser</strong> from Lumenis USA, so the downtime and chances of the side effects are minimal.</p>
      <h3>How long do the effects of fractional CO2 laser resurface last?</h3>
      <p>That depends on how well you protect your skin from the sun and other factors that cause ageing like your general health, smoking, changes in weight, etc. If you do proper sun protection you can maintain the good effects of your <em>CO2 laser treatment</em> for several years. With this treatment you will definitely 'turn the age clock back'</p>
`
        ]
      ...
      <p>Laser energy is attracted to the melanin in our hair. The greater the amount of melanin, the better the results. White or gravy hair does not contain any melanin and, therefore, does not respond to treatments.</p>
      <h3>Do I need to grow the hair for the treatment?</h3>
      <p>No, in fact we ask you to shave the area you want to be treated. Laser actually targets the anatomical structures below the skin. Surface hair actually interferes with the process.</p>
      <p>
`, `<h3>How soon will I see the results?</h3>
      <p>You may see some changes immediately. Duration of one or two weeks will be taken for all of the hair in the treated area to fall. After that, you will experience no growth for several weeks. Therefore, you will be receiving immediate gratification, while you are moving towards a long-term goal.</p>
      <h3>Can I take treatment while I am on other medications?</h3>
      <p>The only medications that are prohibited for  <a href="https://www.drsandeshgupta.com/blog/undertaking-laser-hair-removal-for-clean-looks-by-best-dermatologist-in-east-delhi/" title="Laser Hair Removal Treatment In Delhi"><br/>laser hair removal</a> are Isotretinoin and Retinol-A, which must be discontinued prior to treatment.</p>
      `
...
<li>Moles</li>
<li>Skin Tags</li>
<li>Actinic and Seborrheic keratosis</li>
<li>Epidermal and Dermal Naeve</li>
<li>Rhinophyma</li>
        </ul>
      </div>
      <div class="left35">
...
<li>Angiofibroma</li>
<li>Neurofibroma</li>
<li>Diffuse Actinic Keratoses</li>
        </ul>
      </div>
      <div class="clearfix"></div>
      <p>With comparatively less downtime and post laser scarring, it has become a gold standard in ablative lasers. This laser can penetrate the skin deeper than the traditional removal technology thus clearing the unwanted skin tissues more effectively and without any significant scarring.</p>
 `]
    },
    {
...
<li> No down time and person can immediately return to daily activity.</li>
<li> Makeup and non-irritating creams can usually be applied within a few hours or right after microdermabrasion.</li>
      </ul>
      <p>Since there is an increase in minor skin sensitivity after the procedure, irritating products like glycolic acids or scented creams or lotions are usually avoided right after it.</p>
      <p><strong>Conditions which can be treated are:</strong></p>
      <div class="left35">
        <ul>
...
<li>  Stretch Marks</li>
      ...
      <p><a href="https://www.drsandeshgupta.com/blog/going-through-microdermabrasion-convenient-at-the-hands-of-dermatologist-in-east-delhi/" title="Microdermabrasion Treatment In Delhi"><br/>Microdermabrasion</a> is of two types. In first type we use Aluminium oxide powder to rub your skin and in second type a diamond-tip wand is used to slough off the top layer (epidermis) of your skin and stimulate new skin growth.</p>
      <h3>How does it work?</h3>
      <p>This procedure helps in two ways, first to remove dead layer of the skin and gives you a fresh look. Second, repeated microdermabrasion helps in collagen regeneration; a protein which provides the bulk and health to your skin. Collagen is abundant when we are young and reduces with aging resulting in looser, uneven and wrinkled skin. Microdermabrasion causes thickening of collagen which gives you a young look.</p>
      <p>This procedure is very simple and hardly takes five minutes.The sessions are given at two weeks’ interval and usually six to eight sittings are needed for desired results.</p>
      <h3>What will be the effects?</h3>
      <p>It improves skin complexion and texture. Removes dullness and roughness of the skin and gives you a healthy, glowing and tight skin.</p>
`]
    },
    {
...
`]
    },
    {
      ...
      <ul>
        ...
        <li><strong>Medium peels</strong> can penetrate the skin more deeply than superficial peels and mainly done for deep scars and pigmentation.Egs.Trichloroacetic acid (TCA) </li>
        <li><strong>Mixed peel</strong>, they are more popular these days. They are combination of various chemicals and therapeutic agents, such as mandalic acid, kojic acid, lactic acid, pyruvic acid and mainly used for rejuvenation of skin.</li>
      </ul>
      <h3>How a peel is done?</h3>
      <p>Right before the peel, the skin is cleaned. The chemical (usually a liquid or paste) is then applied to the skin with a small brush, gauze, or cotton-tip applicator and left for few minutes (depending on the condition and type of peel used). Water or alcohol may be used to neutralize it and then it is wiped off. You may feel a little burning during the treatment and mild redness may be there just after the procedure. Dead skin may peel for next two to three days so that new fresh skin can replace. You don't have to be worry about any of these temporary symptoms and just take proper care of your skin which involves:</p>
      <ul>
        <li>Cleansing and moisturizing the skin daily.</li>
...
`]
    },
    {
      ...
      <h3>How often the Derma roller treatment can be repeated?</h3>
      <p>Derma roller treatment is usually recommended for hair therapy, scars and facial rejuvenation and needs to be done at an interval of 15 days to get the desired results.</p>
      <h3>How does the derma roller help in acne scars?</h3>
      <p>The Derma roller causes a controlled micro injury to the skin, which in turn stimulates the formation of new collagen and new blood vessels into the treated area thereby improves the appearance and texture of the scars. It is also effective for reducing pigmentation and helps in skin rejuvenation.</p>
      <h3>How does the derma roller help in controlling the hair loss?</h3>
      <p>The scalp is a thick tissue, and most of the hair stimulating molecules need to be delivered to the hair follicles base which is about 0.5 mm deep. The Derma roller helps in delivering these molecules by creating microchannel through which it can directly reach their point of action. This treatment also increases the blood circulation in the scalp which brings more nutrition to the hair roots.</p>
      <h2>Monotherapy (stem cell based)</h2>
      <p>Stem cells are the cells which have the ability to divide in culture and give rise to specialized cells. Stem cells can be developed into many types of new cells. When we put stem cells in body, these cells divide to generate new cells such as skin and hair cells or can repair the damaged tissue.</p>
      <p>Stem cell supplements bring essential anti-ageing, health & beauty benefits by providing necessary elements to the body to improve cellular regeneration, organ rejuvenation and tissue healing.</p>
      <p><strong>Monotherapy is used in various conditions like</strong></p>
      <div class="left30">
        <ul>
<li> Wrinkles</li>
<li>Hair Loss</li>
...
`]
    },
    {
      ...
      <p>At skin and laser centre, <strong>Botox and fillers</strong> are done by experts. Hence, you will get that lost youthful look in fraction of seconds.</p>`]
    },
    {
      ...
      <p>This technique is suitable for smaller vitiligo areas and the areas where very good cosmetic results are required egg. lips. In this type of grafting, few blisters are formed on normal skin with the help of suction pressure over the period of 2-3 hours, mainly from thighs. After this the roof of the formed blisters is removed and placed over abraded recipient vitiligo skin. Within few days this skin transfers melanocytes to the vitiligo skin and sheds off. After 2-3 months, the transferred melanocytes would re-pigment the vitiligo area.</p>
`]
    },
    {
      ...
      <p><strong>No extra care:</strong> No extra care is required for growth of hair. You can wash, trim, tie hair in any manner. These are original hair.</p>
      `]
    },
    {
...
<li>Dark circle and eye bags</li>
<li>Skin tightening</li>
<li>Stretch marks treatment</li>
      </ul>
      <div class="clearfix"></div>
      <p>Viora reaction combines the mechanism of advanced RF energy and vacuum therapy that work with the body's natural regeneration process to deliver safe and efficient treatments for loose skin, cellulite, body contouring and tightening of the skin. Its unique vacuum therapy maximizes the penetration of RF energy in the treatment area and also increases local blood circulation, stimulates lymphatic drainage and assists in the shrinkage of fat cell volume.</p>
      <p>The skin tightening treatments are suitable for areas of the face and neck such as the jaw, cheeks & brows. The treatment is also suitable for the management of stretch marks on various parts of the body such as the underarm, calves and hips.</p>
      <p>A course of 6-8 sessions are generally recommended for optimal results, however, the difference is visible after the first session only. Each session takes around 20-25 minutes and there is no significant downtime or any side effects. </p>`]
    },
    {
      ...
      <article>
        ...
        <p>Allergic reactions do not happen since the fat is harvested from the patient's own body.</p>
      </article>
      <div class="clear" style="height:15px;"></div>
      ...
      <div class="clear" style="height:15px;"></div>
      <h3>Labiaplasty (Labia Rejuvenation)</h3>
      <article>
        <p>The vagina can be enlarged naturally or due to various reasons like ageing, childbirth, altered hormones or muscle laxity. Labiaplasty reshape the labia (genital lips) in order to enhance its appearance and improve sexual function. During this procedure, excess tissue of the labia minorais is trimmed by removing the upper layer of skin and leaving the underlying tissue intact. Labiaplasty rejuvenates the vagina and helps a woman by boosting her self-confidence and enhances her sexual function.</p>
        <p>Labiaplasty is usually done surgically on an outpatient basis without leaving any scar. However, these days many lasers are also being used for this.</p>
      </article>
      <div class="clear" style="height:15px;"></div>
      ...
      <article>
        ...
        <li>Fat injections involve fat taken from the patient's body.</li>
         <li>Collagen is a cosmetic product derived from purified bovine collagen. </li>
         <li>Restylane is a newer form of injectable filler, that lasts longer than fat and Collagen. Unlike Collagen, Restylane is non-animal based, meaning there is no risk of any allergic reaction. Alloderm, another alternative, is donated human tissue that is inserted into the lips. To learn more about the different types of injectable fillers that can be used for lip augmentation, please consult with a cosmetic surgeon.</li>
      </article>
      <div class="clear" style="height:15px;"></div>
...
`]
    ...
    <ul>
  <li><strong>Sun exposure and sun  damage</strong>- this is the most important avoidable risk factor</li>
  <li><strong>Pregnancy </strong>- in  affected women the pigment often fades a few months after delivery</li>
  <li><strong>Hormone treatments</strong>-  oral contraceptive pills containing oestrogen and/or progesterone, hormone  replacement, intrauterine devices and implants are a factor in about a quarter  of affected women</li>
  <li><strong>Certain medications,  scented or deodorant soaps, toiletries and cosmetics-</strong> these may cause a  phototoxic reaction that triggers melasma, which may then persist long term</li>
  <li><strong>Hypothyroidism -</strong>low  levels of circulating thyroid hormone</li>
  <li><strong>Exposure to ultraviolet  radiation (UVR)- </strong>it deepens the pigmentation because it activates the  melanocytes to produce more melanin.</li>
</ul>

      <p>Melasma is more common in women than in men. It generally starts between the age of 20 and 40 years.</p>
      <h2>Under eye dark circles</h2>
      <p>Dark circles are commonly described as darkness under the lower eyelids due to increased pigmentation (melanin)</p>
      <p><strong>It can be due to various reasons:</strong></p>
      <ul>
<li>Loss of fatty tissue in the eyelid or around the eyes</li>
<li>Bulging fat and muscle loss</li>
<li>Puffy eyelids</li>
<li>Thin, translucent skin</li>
<li>Shadowing due to anatomic shape of the orbit</li>
      </ul>
      <div class="clearfix"></div>
      <h3>Who are more prone to get dark circles?</h3>
      <p>People who are more prone to get dark circles are:</p>
      <ul>
<li> Elderly, however, it can be seen in adolescents also.</li>
<li> People of non-white ethnic background</li>
<li> Genetic predisposition</li>
      </ul>
      <h3>What are the risk factors for dark circles?</h3>
      <p>Loss of fatty tissue in the eyelid or around the eye (tear trough) is associated with:</p>
      <div class="left48">
        <ul>
          <li>Ageing</li>
          <li>Genetic factors</li>
          <li>Lack of nutrition-crash diet</li>
          <li>Lack of sleep</li>
        </ul>
      </div>
      <div class="left48">
        <ul>
          <li>Smoking</li>
          <li>Rubbing or scratching the eyes</li>
          <li>Systemic conditions, particularly, thyroid disease, atopic dermatitis</li>
        </ul>
      </div>
      <div class="clearfix"></div>
      <h3>How dark circles are treated?</h3>
      <p>Treatment of dark circles depends on its nature.</p>
      <p><strong>General measures include:</strong></p>
      <ul>
<li> Adequate sleep and good nutrition</li>
<li>Smoking cessation</li>
<li>Sleep with extra pillows to elevate head and reduce eyelid swelling</li>
<li>Massage temporary swelling while applying a cold compress</li>
<li>Cold compresses also minimize the appearance of prominent blood vessels</li>
      </ul>
      <h3>Medical treatments to reduce pigmentation and Dark eyes</h3>
      <p>Our centre provides specialized treatments for melasma and dark eye pigmentation. Treatments are cost effective and depend upon area, depth, type of skin and cause of pigmentation. In most of the cases combination of treatments are required to treat the pigmentation.</p>
      <p>There are multiple treatment modalities available at our centre.</p>
     <ul>
  <li><strong>IPL (photo facial)</strong>- this is the preferable method used by dermatologists to treat deeper  pigmentation and sun damaged skin.</li>
  <li><strong>Q Switched Nd Yag laser-  </strong>this highly specific laser is used to treat epidermal and dermal  pigmentation in chronic cases.</li>
  <li><strong>Lavatron RF therapy- </strong>this  is a multipolar RF therapy, used to reduce pigmentation and induce new skin  formation and collagen induction.</li>
  <li><strong>Viora reaction-</strong> It is  very effective in Dark circle reduction by opening the lymphatic blockage and  increasing the blood supply of skin near the eyes and helps in skin tightening.</li>
  <li><strong>Chemical peels-</strong> various types of chemical peels are used according to skin conditions which  help in reducing the pigmentation and improving the skin texture.</li>
  <li><strong>Microdermabrasion- </strong>in  combination with other modalities microdermabrasion helps by abrading the skin,  increase vascularity of skin and thus helps in penetration of various medicines  inside the skin.</li>
  <li><strong>Conventional Medicines-</strong> as every melasma has its own reason, it’s very essential to diagnose it  properly and treat various inside factors and deficiencies with the help of  oral and topical medicines.</li>
</ul>`]
    },
    {
      ...
      <p><strong>Various reasons for hair loss are:</strong></p>
   <ul>
  <li>Androgenetic Alopecia</li>
  <li>Alopecia Areata</li>
  <li>Scarring Alopecia</li>
  <li>Telogen Effluvium</li>
  <li>Other causes are: hereditary factors, environmental factors, seborrhoea,  dandruff &amp; scalp infections.</li>
</ul>
      <p>Our centre provides complete and wide range of treatment for any kind of hair problem in form of:</p>
      ...
      <p>The platelet growth factors stimulate the dormant hair follicles which results in the production of new hair and enhance the hair growth and thickness in next 3-4 months.</p>
      <p>
      ...
      <div class="left48">
        <ul>
          <li>Insulin like growth factor-IGF-1</li>
          <li>Basic fibroblast growth factor- FGF</li>
      ...
      <div class="clearfix"></div>
      <h3>How Stem cells acts?</h3>
      <p><strong>Copper peptide:</strong> Inhibit 5 reductase activity for anti-hair-loss</p>
      <p> <strong>IGF-1:</strong> Strengthen hair with stimulating hair follicle to produce healthier hair </p>
      <p><strong>bFGF:</strong> Help hair blood circulation in the scalp and revitalize hair follicle</p>
      <p><strong>VEGF:</strong> Promote the formulation of new blood vessels and formation of new hair follicle.</p>
      <p>Our centre has specializedin stem cell which differentiate into skin keratinocytes and hair follicles.</p>
`]
    },
    {
  ...
  <ul>
  <li>They were too young at that time.</li>
  <li>Just don't want it as its marked for life.</li>
  <li>A name is written in a friendship which is no more.</li>
  <li>My parents got it on me.</li>
  <li>Unwanted for some jobs.</li>
</ul>
      <h3>Laser Tattoo Removal</h3>
      <p><a href = "#" title="Tattoo Removal In Delhi">Tattoo removal</a> is done by lasers that can break down the ink particles in the tattoo. The broken-down ink is then absorbed by the body.</p>
      <p>A tattoo laser must be capable of emitting adequate energy within the given absorption spectrum of the pigment to provide an effective breakage of tattoo pigment. There are other colours in tattoo such as yelloww, green and fluorescent which are more challenging to treat over dark black and blue since they have absorption spectra that fall outside the emission spectra available in the tattoo removal laser. Recent pastel colour inks contain high concentrations of titanium dioxide which is highly reflective. Consequently, such inks are difficult to remove.</p>
      <h3>Mechanism of action</h3>
      <p>Generally, tattoos consist of thousands of particles of tattoo pigment suspended in the skin. Tattoo pigment particles are permanent because they are too big to be removed. Laser treatment causes tattoo pigment particles to heat up and fragment into smaller pieces. These smaller pieces are then removed by normal body processes.</p>
      <p><strong>Laser tattoo removal </strong> is a successful application of the theory of selective photothermolysis (SPTL).</p>
      <p>However, unlike treatments for blood vessels or hair the mechanism required to shatter tattoo particles uses the photo mechanical effect. In this situation the energy is absorbed by the ink particles in a very short time, typically nanoseconds. The surface temperature of the ink particles can rise to thousands of degrees but this energy profile rapidly collapses into a shock wave. This shock wave then propagates throughout the local tissue (the dermis) causing brittle structures to fragment. Hence tissues are largely unaffected since they simply vibrate as the shock wave passes. For <strong>laser tattoo removal</strong> the selective destruction of tattoo pigments depends on four factors:</p>
      <ul>
        <li>The colour of the light must penetrate sufficiently deep into the skin to reach the tattoo pigment.</li>
        <li>The colour of the laser light must be more highly absorbed by the tattoo pigment than the surrounding skin, like red light is highly absorbed by green tattoo pigments.</li>
        <li>The time duration (pulse duration) of the laser energy must be very short, so that the tattoo pigment is heated to fragmentation temperature before its heat can dissipate to the surrounding skin. This duration should be in the order of nanoseconds.</li>
      ...
      <p>Although they occur infrequently, mucosal tattoos can be successfully treated with  <strong>Q-switch lasers </strong> as well.</p>
      <p> Complete <strong>laser tattoo removal</strong> requires numerous treatment sessions, typically spaced at least four weeks apart. At each session, some but not all of the tattoo pigment particles are effectively fragmented, and the body removes the smallest fragments over the course of several weeks. The result is that the tattoo is lightened over time. Remaining large particles of tattoo pigment are then targeted at subsequent treatment sessions, causing further lightening. The number of sessions and spacing between treatments depends on various parameters, including the area of the body treated and skin colour.</p>
      <p>A predictive scale, the "Kirby-Desai Scale", was developed by Rd. Will Kirby and Rd. Alpesh Desai (<a href="dermatologist+in+delhi+best+dermatologist+in+delhi+skin+specialist+in+delhi.html" title="Dermatologists In Delhi">dermatologists</a> with specialization in tattoo removal techniques) is present to assess the potential success and number of treatments necessary for laser <strong>tattoo removal</strong>, Certain colours have proved more difficult to remove than others. For example, the molecular size of the green ink particles being significantly smaller than black colour.</p>
      <h3>R20 method </h3>
      <p>A new technique using two to four passes with the laser, twenty minutes apart, causes more breaking up of the ink than the conventional method.</p>
      <h3>Tattoo Removal Procedure</h3>
      <p>`]
    },
    {
    ...
    <p> <strong>Glutathione</strong> is the most wonderful Skin Whitening Injection which gives quick results as compared to other skin whitening products such as over the counter pills, home remediesand skin whitening creams, which may irritate or damage your skin. This Skin Whitening Injection is quickly absorbed by the skin andis now highly recommended by experts and well-qualified dermatologists. Glutathione is administered in combination with Vitamin C which further boosts the action of Glutathione and makes the resultlong-lasting. You can see the change in your skin right from the first week of using this injection. Skin starts looking fair and bright. It has no harmful side effects when administered in proper dosages by an expert. </p>
     ...
     <ul>
  <li> It removes heavy toxic chemicals from blood cells.</li>
  <li> Repairs damaged cells</li>
  <li> It reduces melanin concentration from the skin and gives bright & fair skin naturally.</li>
  <li> It keeps the skin bright and healthy. In addition to this, it keeps vital organs stronger and functional.</li>
  <li> Skin Whitening Injections mix with blood promptly, therefore, it actively controls hyperpigmentation.</li>
  <li> It smoothens the rough surface of the skin by replenishing damaged cells.</li>
  <li> It resolves common skin problems like wrinkles, fine lines, blemishes, scars, dark circles etc. just in few days.</li>
  <li> It removes acne, pimples effectively and permanently</li>
  <li> It also protects your skin from UV rays</li>
     </ul>`]
    },
    {
        title: "Hydra Facial",
...
<h3>How Does it Work?</h3>
<p>Hydra facial system works by removing the dead skin cells & surface impurities with a multifaceted peeling surface. These powerful tools incorporate a spiral design exfoliation which makes the removal of toxins easy.
</p>
<p>Hydra facial is not just about “instant” glow. It improves the overall quality of the skin by improving the complexion & tone of the skin. With maintenance sessions one can retain the benefits for a long time.</p> 
